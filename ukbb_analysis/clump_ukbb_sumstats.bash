...
#
# Args:
#   $1: Bed file pattern containing reference genome.
#   $2: File pattern with names of duplicate SNPs.
#   $3: Sumstats file to clump.
#   $4: variants.tsv.bgz file containing variant information.
#
